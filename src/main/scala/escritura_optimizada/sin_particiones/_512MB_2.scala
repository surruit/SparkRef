...
import escritura_optimizada.sin_particiones.WriterUtils._
...
object _512MB_2 {
  def main(args: Array[String]): Unit = {
    ...
    val sizePerRow = calcSizePerRow3(spark, df_datos, sparkStaging)

    val partitions = calcTargetPartitions(df_datos, sizePerRow, 512)
